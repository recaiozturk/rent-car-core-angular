...
internal sealed class ApplicationDbContext : DbContext
{
    ...
    {
        configurationBuilder.Properties<IdentityId>().HaveConversion<IdentityIdValueConverter>();//olusturulan IdentityId struct'ının veritabanında Guid olarak saklanması için value converter eklenir -> IdentityIdValueConverter
